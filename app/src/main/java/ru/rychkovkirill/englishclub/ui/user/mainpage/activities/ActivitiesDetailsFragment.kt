 ...
 * Use the [ActivitiesDetailsFragment.newInstance] factory method to
...
class ActivitiesDetailsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ActivitiesDetailsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ActivitiesDetailsFragment().apply {
